package com.zzj.code.chapter6.q21;
...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(multiply(array1)));

        double[] array2 = {1, 2, 0, 4, 5};
        // double expected[] = {0, 0, 40, 0, 0};
        System.out.println(Arrays.toString(multiply(array2)));

        double[] array3 = {1, 2, 0, 4, 0};
        // double expected[] = {0, 0, 0, 0, 0};
        System.out.println(Arrays.toString(multiply(array3)));

        double[] array4 = {1, -2, 3, -4, 5};
        // double expected[] = {120, -60, 40, -30, 24};
        System.out.println(Arrays.toString(multiply(array4)));
        
        double[] array5 = {1, -2};
        // double expected[] = {-2, 1};
        System.out.println(Arrays.toString(multiply(array5)));
    }
}
